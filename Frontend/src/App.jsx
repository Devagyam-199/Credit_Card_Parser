...
function App() {
  ...
  return (
    <Router>
      <div className="min-h-screen bg-gray-50 flex flex-col overflow-hidden" style={{ height: '100vh' }}>
        <Header />
        <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 overflow-auto">
          <Routes>
            <Route 
              path="/" 
              element={
